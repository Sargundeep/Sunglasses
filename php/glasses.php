                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              <li class="nav-item active">
                                 <a class="nav-link" href="../templates_admin/index.html">Home</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="../templates_admin/about.html">About</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="../php/glasses.php">Our Glasses</a>
                              </li> 
                              <li class="nav-item">
                                 <a class="nav-link" href="../templates_admin/wishlist.html">Wish List</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="../templates_admin/cart.html">My Cart</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="../templates_admin/contact.html">Contact Us</a>
                              </li>
